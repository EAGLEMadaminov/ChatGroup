  ...
  return (
    <div className=" bg-[#6C757D] top-0 left-0 bottom-0 right-0">
      <div className="flex h-screen items-center justify-center mx-auto px-[80px] container">
        <div className=" flex flex-col justify-between items-center rounded-l-[20px] text-center h-[400px]  w-full bg-[#212529] text-white p-[50px]">
        ...
        <div className=" bg-white h-[400px] w-full rounded-r-[20px] shadow-lg p-[80px] py-50">
